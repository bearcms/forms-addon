...
$app->bearCMS->addons
    ->register('bearcms/forms-addon', function (\BearCMS\Addons\Addon $addon) use ($app) {
        $addon->initialize = function (array $options) use ($app) {
            ...
            \BearCMS\Internal\Themes::$elementsOptions['form'] = function ($context, $idPrefix, $parentSelector) {
                $groupForm = $context->addGroup(__("bearcms-forms.themes.options.Form"));
                ...
                $addFieldLabel = function ($fieldGroup, string $name, string $attributeValue, string $containerClassName) use ($idPrefix, $parentSelector) {
                    ...
                    $labelGroup->addOption($idPrefix . $name . "LabelCSS", "css", '', [
                        ...
                        "value" => '{"font-family":"Arial","font-size":"14px","line-height":"160%","color":"#000","padding-bottom":"4px"}'
                    ]);
                };
                $addFieldHint = function ($fieldGroup, string $name, string $attributeValue, string $containerClassName) use ($idPrefix, $parentSelector) {
                    ...
                    $hintGroup->addOption($idPrefix . $name . "HintCSS", "css", '', [
                        ...
                        "value" => '{"font-family":"Arial","font-size":"12px","line-height":"140%","color":"#000","padding-bottom":"7px"}'
                    ]);
                };
                ...
                $fieldOpenedListSingleSelectOptionButton->addOption($idPrefix . "FormFieldOpenedListSingleSelectOptionButtonCSS", "css", '', [
                    ...
                    "value" => '{"width":"40px","height":"40px","background-color":"#ffffff","border-top":"1px solid #555","border-bottom":"1px solid #555","border-right":"1px solid #555","border-left":"1px solid #555","border-top-left-radius":"50%","border-top-right-radius":"50%","border-bottom-left-radius":"50%","border-bottom-right-radius":"50%"}'
                ]);
                ...
                $fieldOpenedListSingleSelectOptionButtonChecked->addOption($idPrefix . "FormFieldOpenedListSingleSelectOptionButtonCheckedCSS", "css", '', [
                    ...
                    "value" => '{"background-image":"url(addon:bearcms\/forms-addon:assets\/radio.svg)","background-position":"center center","background-repeat":"no-repeat","background-size":"30px 30px"}'
                ]);
                ...
                $fieldOpenedListSingleSelectOptionText->addOption($idPrefix . "FormFieldOpenedListSingleSelectOptionTextCSS", "css", '', [
                    ...
                    "value" => '{"font-family":"Arial","font-size":"14px","line-height":"24px","color":"#000","padding-top":"8px","padding-left":"10px"}'
                ]);
                ...
                $fieldOpenedListSingleSelectOptionContainer->addOption($idPrefix . "FormFieldOpenedListSingleSelectOptionContainerCSS", "css", '', [
                    ...
                    "value" => '{"padding-bottom":"5px"}' // todo except the last one
                ]);
                ...
                $fieldOpenedListMultiSelectOptionButton->addOption($idPrefix . "FormFieldOpenedListMultiSelectOptionButtonCSS", "css", '', [
                    ...
                    "value" => '{"width":"40px","height":"40px","background-color":"#ffffff","border-top":"1px solid #555","border-bottom":"1px solid #555","border-right":"1px solid #555","border-left":"1px solid #555","border-top-left-radius":"2px","border-top-right-radius":"2px","border-bottom-left-radius":"2px","border-bottom-right-radius":"2px"}'
                ]);
                ...
                $fieldOpenedListMultiSelectOptionButtonChecked->addOption($idPrefix . "FormFieldOpenedListMultiSelectOptionButtonCheckedCSS", "css", '', [
                    ...
                    "value" => '{"background-image":"url(addon:bearcms\/forms-addon:assets\/checkbox.svg)","background-position":"center center","background-repeat":"no-repeat","background-size":"20px 20px"}'
                ]);
                ...
                $submitButton->addOption($idPrefix . "FormSubmitButtonCSS", "css", '', [
                    ...
                    "value" => '{"background-color":"#333333","font-size":"14px","font-family":"Arial","height":"40px","line-height":"40px","padding-left":"13px","padding-right":"13px","color":"#ffffff","border-top-left-radius":"2px","border-top-right-radius":"2px","border-bottom-left-radius":"2px","border-bottom-right-radius":"2px"}'
                ]);
